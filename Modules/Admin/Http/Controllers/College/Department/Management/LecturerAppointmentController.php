...
class LecturerAppointmentController extends AdminBaseController
{
    ...
    public function createHeadOfDepartment($department,$departmentId, $lecturerId)
    {
        return view('admin::college.appointment.college_directer',['lecturer'=>Lecturer::find($lecturerId)]);
    }

<div class="col-md-4">
    <!-- course item -->
    <a href="#" data-target="#allocation_2" data-toggle="modal">
    <div class="course-item shadow">
        ...
        <div class="course-date bg-color-1 clear-fix">
            <div class="h5">
                ...
                @foreach(currentSession()->semesterCalendars->where('semester_id',2) as $semesterCalendar)
...
<div class="col-md-4">
    <!-- course item -->
    <a href="#" data-target="#lecture_2" data-toggle="modal">
    <div class="course-item shadow">
        <div class="course-name clear-fix">
...
<div class="col-md-4">
    <!-- course item -->
    <a href="#" data-target="#exam_2" data-toggle="modal">
	    <div class="course-item shadow">
	        <div class="course-name clear-fix">
...
<div class="col-md-4">
    <!-- course item -->
    <a href="#" data-target="#marking_2" data-toggle="modal">
	    <div class="course-item shadow">
	        <div class="course-name clear-fix">
...
<div class="col-md-4">
    ...
    <a href="#" data-toggle="modal" data-target="#upload_2">
	    <div class="course-item shadow">
	        <div class="course-name clear-fix">

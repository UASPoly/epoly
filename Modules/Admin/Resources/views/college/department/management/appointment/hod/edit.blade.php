...
<div class="col-md-4">
    <br><br>
    <form class="login-form" action="{{route('admin.college.department.appointment.hod.update',[$lecturer->id])}}" method="post">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="text"  value="{{$lecturer->staff->headOfDepartment->email}}" name="email" class="form-control" />
        </div>
        <div class="form-group">
            <label>Gender</label>
        ...
        <div class="form-group">
            ...
            <input type="date" value="{{$lecturer->staff->headOfDepartment->from}}" name="appointment_date" class="form-control" placeholder="college name">
            @error('name')
        ...
        <button class="button-fullwidth cws-button bt-color-3">Update Appointment'</button>
    </form>
</div>
@endsection
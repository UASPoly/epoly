...
@section('page-content')
	...
	<div class="col-md-12">
		...
		<div class="card shadow">
			<br>
			<div class="col-md-12">
	            <button class="btn-block button-fullwidth cws-button bt-color-3 shadow"><a href="{{route('admin.college.department.management.lecturer.create',[$department->id])}}">New Lecturer</a></button>
	        </div>

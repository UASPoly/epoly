<div class="col-md-12">
	...
	<div class="card shadow">
		<div class="card-header shadow">
			<h5 class="center">LIST OF REGISTERED STUDENTS IN {{strtoupper(department()->name)}}  FOR {{currentSession()->name}} SESSION</h5>
		</div>
		<div class="card-body">
			     	...
			     	<tbody>
			     		...
			     		<tr>
			     			...
			     			<td>
			     				...
			     				<button class="btn btn-warning " ><a href="{{route($route['revoke'] ?? 'department.admission.revoke',['admission_id'=>$admission->id])}}" style="color: white" onclick="confirm('Are you sure you want to revoke this student from having access to his account')" class="text text-primary">{{$admission->student->is_active == 1 ? 'Revoke' : 'Activate'}}</a></i>
			     				</button>
			     			</td>
			     		</tr>
			     		@endforeach

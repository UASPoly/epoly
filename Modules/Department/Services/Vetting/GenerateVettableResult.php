...
class GenerateVettableResult
{
	...
	{
        return SessionRegistration::where(['department_id'=>$this->department->id,'session_id'=>$this->data['session'],'programme_level_id'=>$this->data['level']])->paginate($this->data['paginate']) ;
	}
